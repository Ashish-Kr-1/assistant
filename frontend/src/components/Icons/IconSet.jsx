// Single inline-SVG icon set for the IP-SAKTI Sahayak UI. Using one
// component with a `name` switch keeps every call site a one-liner
// (`<Icon name="book" />`) instead of importing dozens of named exports.
...
const PATHS = {
  ...
  "shield-check": (
    <>
      <path d="M12 2 4 5v6c0 5 3.4 8.7 8 11 4.6-2.3 8-6 8-11V5z" />
      <polyline points="9 12 11 14 15.2 9.6" />
    </>
  ),
  globe: (
    <>
  ...
  paperclip: (
    <path d="M21.4 11.1 12.5 20a4.9 4.9 0 0 1-7-7l8.5-8.5a3.3 3.3 0 0 1 4.7 4.7L10 17.9a1.7 1.7 0 0 1-2.4-2.4l7.1-7.1" />
  ),
  bell: (
    <>
  ...
  leaf: (
    <>
      <path d="M4 20c7-1 12-6.5 13-15C10.5 6 5 11 4 20z" />
      <path d="M9 15c2-3 5-5.5 8-9" />
    </>
  ),
  plus: (
    <>
